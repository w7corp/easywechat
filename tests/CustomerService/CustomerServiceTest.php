...
use EasyWeChat\CustomerService\CustomerService;
...
class CustomerServiceTest extends TestCase
{
    ...
    {
        $customerService = \Mockery::mock('EasyWeChat\CustomerService\CustomerService[parseJSON]', [\Mockery::mock('EasyWeChat\Core\AccessToken')]);
