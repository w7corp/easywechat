...
class ClientTest extends TestCase
{
    public function testCreate()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/component/create', ['appid' => 'app-id'])->andReturn('mock-result')->once();
    ...
    public function testBindTo()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/component/bind', ['appid' => 'app-id', 'open_appid' => 'open-app-id'])->andReturn('mock-result')->once();
    ...
    public function testUnbindFrom()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/component/unbind', ['appid' => 'app-id', 'open_appid' => 'open-app-id'])->andReturn('mock-result')->once();
    ...
    public function testGetBinding()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/component/get', ['appid' => 'app-id'])->andReturn('mock-result')->once();
