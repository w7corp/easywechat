...
use EasyWeChat\Applications\OfficialAccount\Menu\Client as Menu;
...
class ClientTest extends TestCase
{
    ...
    {
        $menu = \Mockery::mock('EasyWeChat\Applications\OfficialAccount\Menu\Client[parseJSON]', [\Mockery::mock('EasyWeChat\Applications\OfficialAccount\Core\AccessToken')]);
