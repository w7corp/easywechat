...
use EasyWeChat\Applications\OfficialAccount\CustomerService\SessionClient as Session;
...
class SessionTest extends TestCase
{
    ...
    {
        $session = \Mockery::mock('EasyWeChat\Applications\OfficialAccount\CustomerService\SessionClient[parseJSON]', [\Mockery::mock('EasyWeChat\Applications\OfficialAccount\Core\AccessToken')]);
