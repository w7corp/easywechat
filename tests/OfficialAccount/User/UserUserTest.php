...
use EasyWeChat\OfficialAccount\User\User;
...
class UserUserTest extends TestCase
{
    ...
    {
        $user = \Mockery::mock('EasyWeChat\OfficialAccount\User\User[parseJSON]', [\Mockery::mock('EasyWeChat\OfficialAccount\Core\AccessToken')]);
