...
class ClientTest extends TestCase
{
    ...
    {
        $press = \Mockery::mock('EasyWeChat\Applications\OfficialAccount\Comment\Client[parseJSON]', [\Mockery::mock('EasyWeChat\Applications\OfficialAccount\Core\AccessToken')]);
