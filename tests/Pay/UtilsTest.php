...
class UtilsTest extends TestCase
{
    ...
    public function test_generate_sign()
    {
        ...
        $result = $utils->generate_sign($params, 'mock-v2-secret-key', $utils->get_encrypt_method($params['signType'], 'mock-v2-secret-key'));

        $this->assertSame('C52D6B09E8A039D6E8696A014BB37160', $result);

        $params['signType'] = 'HMAC-SHA256';
        $result = $utils->generate_sign($params, 'mock-v2-secret-key', $utils->get_encrypt_method($params['signType'], 'mock-v2-secret-key'));
        $this->assertSame('BAC9240577E86EDC7753264E502196C61F78F24777E9E7CCE82A7BD97F906EED', $result);

        ksort($params);
        $params['key'] = 'mock-v2-secret-key';
        $result = $utils->get_encrypt_method($params['signType'], 'mock-v2-secret-key')(urldecode(http_build_query($params)));
        $this->assertSame('BAC9240577E86EDC7753264E502196C61F78F24777E9E7CCE82A7BD97F906EED', strtoupper($result));
    }
}
