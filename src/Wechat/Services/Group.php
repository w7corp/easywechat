...
class Group extends Service
{
    ...
    public function create($name)
    {
        ...
        $response = $this->request('POST', self::API_CREATE, $params);
    ...
    public function update($groupId, $name)
    {
        ...
        $this->request('POST', self::API_UPDATE, $params);
    ...
    public function user($groupId, $openId)
    {
        ...
        $this->request('POST', self::API_MEMBER_UPDATE, $params);
    ...
    public function users($groupId, array $openIds)
    {
        ...
        $this->request('POST', self::API_MEMBER_BATCH_UPDATE, $params);
